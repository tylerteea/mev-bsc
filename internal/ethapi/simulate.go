...
func (m *simChainHeadReader) GetTd(hash common.Hash, _ uint64) *big.Int {
	return m.Backend.GetTd(m.Context, hash)
}

func (m *simChainHeadReader) GenesisHeader() *types.Header {
	return m.Backend.Chain().GenesisHeader()
}
...
func (m *simChainHeadReader) GetVerifiedBlockByHash(hash common.Hash) *types.Header {
